...
- `git clone https://github.com/UniversalPropositions/UP_Telugu-MTG.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Telugu-MTG>/ --input_up=<up_path_to_UP_Telugu-MTG>/ --output=<path_to_UD+UP_Telugu-MTG>/`
